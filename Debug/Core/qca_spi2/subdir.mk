...
C_SRCS += \
../Core/qca_spi2/CDC_framing.c 

OBJS += \
./Core/qca_spi2/CDC_framing.o 

C_DEPS += \
./Core/qca_spi2/CDC_framing.d 


# Each subdirectory must supply rules for building sources it contributes
Core/qca_spi2/%.o Core/qca_spi2/%.su Core/qca_spi2/%.cyclo: ../Core/qca_spi2/%.c Core/qca_spi2/subdir.mk
...
clean: clean-Core-2f-qca_spi2

clean-Core-2f-qca_spi2:
	-$(RM) ./Core/qca_spi2/CDC_framing.cyclo ./Core/qca_spi2/CDC_framing.d ./Core/qca_spi2/CDC_framing.o ./Core/qca_spi2/CDC_framing.su

.PHONY: clean-Core-2f-qca_spi2
