...
//extern void ComPort_Config(void);

extern UART_HandleTypeDef huart5;		//from main.c

//uint8_t host_com_port_1_open = 0;
...
//void ComPort_Stop(void){
//	UART_HandleTypeDef *Puart = &huart5;
//	if(HAL_UART_DeInit(Puart) != HAL_OK){
//		Error_Handler();
//	}
//	if(HAL_UART_DMAStop(Puart) != HAL_OK){
//			Error_Handler();
//		}
//	__HAL_UART_DISABLE(Puart);
//}
...
static int8_t CDC_Receive(uint8_t cdc_ch, uint8_t *Buf, uint32_t *Len)
{
  ...
  //HAL_UART_Transmit_DMA(CDC_CH_To_UART_Handle(cdc_ch), Buf, *Len);
	 switch (cdc_ch){
	 	 case 0:		//port 0
	 		USER_CDC_RxHandler_0(Buf, *Len);
	 		 break;
	 	 case 1:		//pot 1
	 		 //USER_CDC_RxHandler_1(Buf, *Len);
	 		 //CDC_Transmit(cdc_ch, Buf, *Len); // echo loop back on same channel
	 		 break;
	 	 case 2:		//pot 2
	 	 case 3:		//pot 3
	 	 default:
...
static int8_t CDC_TransmitCplt(uint8_t cdc_ch, uint8_t *Buf, uint32_t *Len, uint8_t epnum)
{
	 switch (cdc_ch){
	 	 case 0:		//port 0
	 		 USER_CDC_TxCpltcallBack_0(Buf, *Len);
	 		 break;
	 	 case 1:		//pot 1
	 		 //CDC_Transmit(cdc_ch, Buf, *Len); // echo back on same channel
	 		//USER_CDC_TxCpltcallBack_1(Buf, *Len);
	 		 break;
	 	 case 2:		//pot 2
	 	 case 3:		//pot 3
	 	 default:
